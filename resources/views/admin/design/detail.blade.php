...
<div class="hw-content" style="padding: 20px;">
    <form action="/admin/article/handle" method="post" class="am-form" id="form-admin-add" enctype="multipart/form-data">
        ...
        {{--<div class="am-g am-margin-top">--}}
            {{--<div class="am-u-sm-3 am-u-md-2 am-text-right">定制标题</div>--}}
            {{--<div class="am-u-sm-8 am-u-md-10">--}}
                {{--<input type="hidden" name="articleid" value="{{$data->articleid}}">--}}
                {{--<input type="text" class="am-input-sm" name="title" placeholder="" value="{{$data->title}}">--}}
            {{--</div>--}}
        ...
        <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
                {{--<input type="hidden" name="articleid" value="{{$data->articleid}}">--}}
                <input type="text" class="am-input-sm" name="phone" placeholder="" value="{{$data->phone}}">
            </div>
            <div class="am-hide-sm-only am-u-md-6"></div>
        </div>
        <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
                {{--<input type="hidden" name="articleid" value="{{$data->articleid}}">--}}
                <input type="text" class="am-input-sm" name="phone" placeholder="" value="{{$data->title}}">
            </div>
            <div class="am-hide-sm-only am-u-md-6"></div>
        </div>
        <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
                {{--<script id="content" type="text/plain" style="width:100%;height:400px;" name="content">{!! $data->content !!}</script>--}}
